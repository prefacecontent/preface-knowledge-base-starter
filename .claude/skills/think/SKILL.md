...
This is the meta-skill that informs how the other wiki skills think. Several of them carry a per-skill "How to think" appendix mapping these 10 stages to that skill's specific work.
...
In practice: read-before-write. Name like the next reader is hostile. Smallest unit that works. Delete more than you add. Evidence over intuition. Failure is the spec. THINK is where rigor pays off, but it cannot start without 1-3.
...
In practice: when adding a new wiki page or skill, audit how it integrates with the rest of the vault — the index, the log, the hot cache, the cross-links. The page that exists in isolation but nothing links to is not yet part of the wiki.
...
### 6. CONNECT (system)
- How does this plug into the existing wiki? (Index, log, hot cache, cross-links, the other skills)
...
The 10-principle framework composes with the rest of the wiki skills:
...
- **`/autoresearch`**: A LISTEN amplifier — surfaces external signals you would not have found alone.

Several wiki skills carry a "How to think" appendix mapping their specific work to these 10 stages. Read those appendices for skill-specific applications.

---

## Reference

- This skill is the canonical source for the 10-principle framework in this vault.
